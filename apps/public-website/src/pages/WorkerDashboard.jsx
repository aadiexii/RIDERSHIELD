...
export default function WorkerDashboard() {
  return (
    <div
      className="min-h-screen bg-[#0a0a0a] flex flex-col items-center px-8 pt-10 pb-16"
    ...
    >
      ...
      <div className="text-center w-full max-w-2xl mx-auto flex flex-col items-center">
        ...
        <p className="text-zinc-400 text-base leading-relaxed max-w-lg mx-auto mt-4 mb-8">
