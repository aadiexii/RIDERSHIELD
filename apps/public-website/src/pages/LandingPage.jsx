  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        {screen === 'select' && (
          <div className="p-8">
            <div className="mb-7">
              ...
              <p className="text-sm text-zinc-500">Download the app to register as a rider.</p>
            </div>
        ...
        {/* ── SCREEN 2: Rider — app download info ── */}
        {screen === 'rider' && (
          <div className="p-8">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-400 font-sans selection:bg-orange-500 selection:text-white flex flex-col">
      ...
      {/* ══════════════════════════ HERO ════════════════════════════════════ */}
      <section
        className="relative min-h-[85vh] flex overflow-hidden pt-16 pb-16"
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-start">

          {/* Left */}
          <div className="space-y-7">
            {/* ── Backed by Users Badge ── */}
            <div className="inline-flex items-center gap-2 pl-4 pr-5 py-2 bg-white/5 border border-white/10 rounded-xl cursor-default mb-2">
              <span className="text-white font-semibold text-[15px] tracking-wide font-sans">Backed by</span>
              <div className="flex items-center">
                <div className="w-6 h-6 flex items-center justify-center bg-[#ff6b00] rounded-[6px] shadow-[0_1px_3px_rgba(255,107,0,0.4)] mr-[1px]">
                  <span className="text-white font-bold text-sm font-sans leading-none">U</span>
                </div>
                <span className="text-white font-semibold text-[15px] tracking-wide font-sans">sers</span>
              </div>
            </div>
